...
export function initForm<TInputMethodRecord extends InputMethodRecord>(inputs?: TInputMethodRecord, labels?: Record<string, string>) {
  return {
    inputMethods: <TInputMethodRecord extends InputMethodRecord>(inputs: TInputMethodRecord) => initForm(inputs),
      ...
      return {
        inputs: new Proxy({}, {
          get: (_, props) => {
            ...
            [K in keyof TInputMethodRecord]: (...args: inferInputMethodProps<TInputMethodRecord[K]>) => inferInputMethodWithComponentProps<TInputMethodRecord[K]>
          },
        Form: <TRecord extends InputMethodWithComponentPropsRecord,>({ fields }: { fields: TRecord }) => <Form fields={fields} labels={labels} />
      }
    }
  }
}
...
export function Form<TRecord extends InputMethodWithComponentPropsRecord>({ fields, labels }: FormProps<TRecord>) {
  return (
    <RadixForm.Root>
